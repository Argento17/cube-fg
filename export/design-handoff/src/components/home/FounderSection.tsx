      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="grid items-start gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            <div
              className="relative aspect-[4/5] w-full max-w-md overflow-hidden rounded-sm border border-cube-navy/15 bg-gradient-to-br from-cube-navy/5 to-cube-sapphire/10"
              role="img"
              aria-label={`תמונת ${content.name}`}
            >
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-6xl font-bold text-cube-navy/20">
                  {content.name.charAt(0)}
                </span>
              </div>
              <div className="absolute bottom-0 start-0 h-1 w-16 bg-cube-gold" />
            </div>
          </div>
