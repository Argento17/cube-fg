  ...
  return (
    <header
      className={`sticky top-0 z-50 border-b transition-all duration-300 ${
        scrolled
          ? "border-cube-navy/15 bg-cube-neutral/98 py-2.5 shadow-sm backdrop-blur-md"
          : "border-cube-navy/10 bg-cube-neutral/95 py-3 backdrop-blur-md md:py-4"
      }`}
    >
      <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 md:gap-8 md:px-6">
        {/* Brand zone — start (RTL right) */}
        <div className="min-w-0 shrink-0 md:min-w-[300px] lg:min-w-[340px]">
